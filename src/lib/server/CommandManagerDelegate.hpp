...
#ifndef OPENHLXSERVERCOMMANDMANAGERDELEGATE_HPP
#define OPENHLXSERVERCOMMANDMANAGERDELEGATE_HPP
...
/**
 *  @brief
 *    A delegate interface for the HLX server command manager object.
 *
...
#endif // OPENHLXSERVERCOMMANDMANAGERDELEGATE_HPP
