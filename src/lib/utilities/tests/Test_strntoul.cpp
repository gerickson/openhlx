...
/**
 *    @file
 *      This file implements a unit test for strntoul.
 *
 */
                             ...
                             void *inContext __attribute__((unused)))
{
    ...
    lResult = strntoul("10", 2, nullptr, 1);
    ...
    lResult = strntoul("10", 2, nullptr, 37);
    NL_TEST_ASSERT(inSuite, lResult == 0);
    NL_TEST_ASSERT(inSuite, errno == EINVAL);
    ...
    lResult = strntoul("10", 2, nullptr, 2147483629);
    NL_TEST_ASSERT(inSuite, lResult == 0);
    NL_TEST_ASSERT(inSuite, errno == EINVAL);
    ...
    lResult = strntoul("10", 2, nullptr, -3);
    NL_TEST_ASSERT(inSuite, lResult == 0);
    NL_TEST_ASSERT(inSuite, errno == EINVAL);
}
                           ...
                           void *inContext __attribute__((unused)))
{
    ...
    lResult = strntoul(lString, 0, &lEnd, 2);
    NL_TEST_ASSERT(inSuite, lResult == 0);
    ...
    lResult = strntoul(lString, 0, &lEnd, 8);
    NL_TEST_ASSERT(inSuite, lResult == 0);
    NL_TEST_ASSERT(inSuite, lEnd == lString);
    NL_TEST_ASSERT(inSuite, errno == 0);
    ...
    lResult = strntoul(lString, 0, &lEnd, 10);
    NL_TEST_ASSERT(inSuite, lResult == 0);
    NL_TEST_ASSERT(inSuite, lEnd == lString);
    NL_TEST_ASSERT(inSuite, errno == 0);
    ...
    lResult = strntoul(lString, 0, &lEnd, 16);
    NL_TEST_ASSERT(inSuite, lResult == 0);
    NL_TEST_ASSERT(inSuite, lEnd == lString);
    NL_TEST_ASSERT(inSuite, errno == 0);
                           ...
                           void *inContext __attribute__((unused)))
{
    ...
    lResult = strntoul(lString, lLength, &lEnd, 10);
                             ...
                             void *inContext __attribute__((unused)))
{
    ...
    lResult = strntoul(lString, lLength, &lEnd, 2);
    ...
    lResult = strntoul(lString, lLength, &lEnd, 8);
    NL_TEST_ASSERT(inSuite, lResult == 7);
    NL_TEST_ASSERT(inSuite, lEnd == lString + lLength);
    NL_TEST_ASSERT(inSuite, errno == 0);
                         ...
                         void *inContext __attribute__((unused)))
{
    ...
    lResult = strntoul(lString, lLength, &lEnd, 16);
    NL_TEST_ASSERT(inSuite, lResult == ULONG_MAX);
    NL_TEST_ASSERT(inSuite, lEnd == lString + lLength);
                           ...
                           void *inContext __attribute__((unused)))
{
    ...
    lResult = strntoul(lString, lLength, &lEnd, 10);
    NL_TEST_ASSERT(inSuite, lResult == 18446744073709551614ul);
    NL_TEST_ASSERT(inSuite, lEnd == lString + lLength);
    NL_TEST_ASSERT(inSuite, errno == 0);
    ...
    //
    // For these tests, with a length of one (1), strntoul will be
