...
{
    Client::EqualizerPresetsControllerBasis *  lController = static_cast<Client::EqualizerPresetsControllerBasis *>(this);
    Status                                     lStatus;
    ...
    lStatus = ProxyNotification(aBuffer,
                                aSize,
                                aMatches,
                                Client::EqualizerPresetsControllerBasis::EqualizerBandNotificationReceivedHandler,
                                lController);
...
EqualizerPresetsController :: NameNotificationReceivedHandler(const uint8_t *aBuffer, const size_t &aSize, const RegularExpression::Matches &aMatches)
{
    ...
    lStatus = ProxyNotification(aBuffer,
                                aSize,
                                aMatches,
                                Client::EqualizerPresetsControllerBasis::NameNotificationReceivedHandler,
                                lController);
    nlREQUIRE_SUCCESS(lStatus, done);
